...
PLDR.I18N = {
  ...
  HU = {
    ...
    ["BDMA Mode"] = "BDMA mód",
    ["BDMA and SMB modules -- from mc0: / mc1:. They won't"] = "BDMA és SMB modulok -– az mc0: / mc1: eszközökről.",
    ...
    ["Center aligned"] = "Középre igazított",
    ...
    ["Couldn't save settings -- POPSTARTER folder NOT deleted"] = "A beállítások mentése nem sikerült –- a POPSTARTER mappa NEM lett törölve",
    ...
    ["Failed to load HDD"] = "A merevlemez betöltése nem sikerült",
    ["Failed to load HDD (exFAT)"] = "A HDD (exFAT) betöltése nem sikerült",
    ...
    ["Hidden games are filtered out.\nPress R3 to reveal them, then L3 to unhide."] = "A rejtett játékok kiszűrésre kerülnek.\nNyomja meg az R3 gombot az elrejtésükhöz, majd az L3 gombot a megjelenítésükhöz.",
    ["Hidden games filtered out again"] = "A rejtett játékok kiszűrve",
    ["Hide Text"] = "Szöveg elrejtése",
    ["Hide UI Text"] = "UI szövegek elrejtve",
    ...
    ["Profile"] = "Profil",
    ["Profile defaults restored"] = "Alapértelmezett profil beállítások visszaállítva",
    ...
    ["Return to OSDSYS?"] = "Vissza az OSDSYS-hez?",
    ["Revert"] = "Visszavon",
    ...
    ["Scanning HDD partitions..."] = "Merevlemez-partíciók beolvasása...",
    ...
    ["Scanning exFAT HDD games..."] = "Az exFAT HDD-n lévő játékok beolvasása...",
    ...
    ["Show all discs"] = "Minden lemez megjelenítése",
    ["Showing hidden games (dimmed) -- press L3 to unhide"] = "Rejtett játékok megjelenítése (elhalványítva) –- L3 megnyomásával láthatóvá tehetők",
    ["Shown"] = "Megjelenítve",
    ["Startup"] = "Indítás",
    ["Static (manual)"] = "Statikus (manuális)",
    ["Storage"] = "Tároló",
    ["This backend isn't implemented yet"] = "Ez a háttérrendszer még nincs megvalósítva",
    ["This removes the POPSTARTER pack -- including the"] = "Ezzel eltávolítja a POPSTARTER csomagot –- beleértve a",
    ["Triangle"] = "Háromszög",
    ...
    ["manually). Your POPSLoader settings are kept."] = "kézzel). A POPSLoader beállításai megmaradnak.",
    ["return until you turn this back On (or re-add them"] = "addig nem jelennek meg, amíg ezt újra be nem kapcsolja (vagy újra hozzá nem adja őket)",
  },
}
function PLDR.L(s)
...
function PLDR._AtaStage(pct, msg)
  ...
  local step = math.floor((tonumber(pct) or 0) * 100 + 0.5)
  if PLDR._ata_marker_last ~= step then
    PLDR._ata_marker_last = step
    PLDR.SetAtaProbeMarker(step)
  end
end
