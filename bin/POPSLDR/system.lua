...
local function EncodeSettings()
  local lines = {
    ...
    "ART_ENABLED="..tostring(PLDR.ART_ENABLED and 1 or 0)
  }
...
function PLDR.LoadSettingsNonFatal()
  ...
  if art_enabled ~= nil then
    local normalized = string.lower(tostring(art_enabled))
    PLDR.ART_ENABLED = (normalized == "1" or normalized == "true" or normalized == "yes" or normalized == "on")
  end
  PLDR.ReconcileBdmaModeWithEffectiveState()
  return true
end
