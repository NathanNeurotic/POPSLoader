...
PLDR.I18N = {
  ...
  HU = {
    ...
    ["return until you turn this back On (or re-add them"] = "addig nem jelennek meg, amíg ezt újra be nem kapcsolja\n(vagy újra hozzá nem adja őket)",
  },
}
function PLDR.L(s)
