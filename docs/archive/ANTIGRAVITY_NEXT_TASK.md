...
- [docs/U10_INVESTIGATION.md](U10_INVESTIGATION.md) — U-10 BOOT.ELF-from-HDD-boot hypothesis catalog (now an accepted known-broken item in BETA-10-5; investigation preserved)
- [docs/DOCUMENTATION_FOLLOWUP_AUDIT.md](DOCUMENTATION_FOLLOWUP_AUDIT.md) — post-release doc cleanup plan
