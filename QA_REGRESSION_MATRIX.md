...
| 2026-04-19 | Unknown (not reported) | HDD boot; HDD sidecar/cwd `POPSTARTER.ELF`; HDD game on no-SIF-teardown HDD-path source (`SifExitCmd` skipped before `ExecPS2(loader)` when IOP not reset) | D-10 | Unknown (verify on hardware) |
