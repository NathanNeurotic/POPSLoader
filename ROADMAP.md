...
- Current source applies explicitly targeted fixes for D-10: unmounting `pfs0:` before `ExecPS2` to avoid POPSTARTER block collision, and bypassing `SifExitRpc` to keep IOP alive. Waiting for hardware test.
