...
bool is_valid_root(const char *root)
{
	...
	if (!strcmp(root, "mass0:/") || !strcmp(root, "mass1:/") ||
		!strcmp(root, "mass2:/") || !strcmp(root, "mass3:/")) {
		return true;
	}
	return false;
}
...
bool normalize_root(const char *devroot, char *out, size_t outsz)
{
	...
	if (devroot != NULL && devroot[0] != '\0') {
		...
		else if (!strcmp(device, "mass0") || !strcmp(device, "mass1") ||
				 !strcmp(device, "mass2") || !strcmp(device, "mass3")) {
			selected = devroot;
		}
	}
